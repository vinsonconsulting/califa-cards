...
content_hash: sha256:45fa1bfd55b7a3985acc9fa799387a815a02d2d9695589385d4a1fd8f796a155
...
triggers:
  ...
  negative:
  - prompt: parse these command-line flags
    use_instead: click-cli
  - prompt: print a colored table to stdout
    use_instead: rich-render
